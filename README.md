# 🐜 Hormiga Scalper v1 (Polymarket BTC 15m)

![Hormiga Scalper v1](./assets/announcement.jpg)

Micro-scalping intrasesión para mercados binarios de corta duración (quince minutos), con control estricto de riesgo y **una sola posición activa**.

## 🎯 Filosofía (ES)
Hormiga Scalper no intenta predecir el resultado final del mercado. No juega a “acertar la resolución”. Captura pequeños movimientos intrasesión mediante exposición limitada, una sola posición activa, salida obligatoria antes de resolución, take-profit y stop-loss definidos, y cierre por tiempo máximo. La meta no es un gran trade. Es consistencia pequeña y repetible.

## 🎯 Philosophy (EN)
Hormiga Scalper does not attempt to predict the final outcome of a market. It does not play the “resolution guessing” game. It captures small intraday movements through limited exposure, a single active position at a time, mandatory exit before resolution, defined take-profit and stop-loss, and maximum holding time enforcement. The goal is not a big trade. It is small, repeatable consistency.

## ⚠️ Disclaimer
Educational project. Not financial advice. Use at your own risk.

## ☕ Alimenta la Hormiga / Fuel the Ant
Si la Hormiga te ayudó a pensar distinto sobre riesgo y disciplina, puedes invitarle un café:
https://www.buymeacoffee.com/izaivi

If Hormiga helped you think differently about risk and discipline, you can buy the ant a coffee:
https://www.buymeacoffee.com/izaivi

## Credits / Attribution
Based on original work by @krajekis (console UI/template credit). This repository contains substantial modifications and strategy/risk logic added by izaivi.
